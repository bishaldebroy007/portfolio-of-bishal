                ...
                <div className="hero-content text-center">
                    <div className="max-w-md px-4 sm:px-6">
                        ...
                        <a
                            ...
                            className="btn bg-green-700 hover:scale-105 duration-300 hover:bg-green-500 hover:text-black text-white rounded-2xl mt-3 sm:mt-4 hover:outline-2 font-normal text-lg sm:text-xl md:text-2xl animate__animated animate__rubberBand animate__delay-1.5s"
                        >
                            Download Resume
                        </a>
                    </div>
