            ...
            <div className="hero bg-base-200 min-h-[750px]">
                <div className="hero-content text-center">
                    <div className="max-w-md">
                        ...
                        <h1 className="text-5xl font-bold title-styles styles_typicalWrapper__1_Uvh">Bishal Deb Roy</h1>
                        <a
                            href="/Resume_Bishal.pdf" // Replace with actual path
                            download="Bishal Deb Roy_Resume.pdf" // Suggested filename for download
                            className="btn bg-green-700 hover:scale-105 duration-300  hover:bg-green-500 hover:text-black text-white rounded-xl mt-4 font-normal text-2xl animate__animated animate__flip animate__delay-1.5s"
                        >
                            Resume
                        </a>
                    </div>
